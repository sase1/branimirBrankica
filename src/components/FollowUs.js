...
export default function FollowUs() {
    return (
        <div className="row instagram-images position-relative mb-3">
            ...
            <div className="col-lg-2 col-md-4 col-6 item item1">
                <Link to="https://www.instagram.com/branimir_i_brankica/?hl=en" target="_blank" className="overlay text-decoration-none text-white">Види на Инстаграм</Link>
            </div>
